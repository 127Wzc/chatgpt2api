...
class ImageEditsJsonApiTests(unittest.TestCase):
    ...
    def test_image_edit_accepts_remote_json_url(self, get_mock):
        get_mock.return_value.status_code = 200
        get_mock.return_value.headers = {"content-type": "image/png"}
        get_mock.return_value.content = b"remote-png"
